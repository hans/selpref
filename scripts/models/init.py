class SelectionalPreferenceModel(object):
    ...
    def evaluate(self, examples, answers):
        """
        evaluate the performance of the model
        TODO: can probably implement this abstractly in terms of the `pseudo_disambiguate`
        examples are in the same format to that of `pseudo_disambiguate`;
        answers should be a sequence of `0` and `1`, same to the format of `pseudo_disambiguate`
        """
